...
from work_site.core.models import Classifiable
from work_site.job.models import JobPost, ContentTaggable


class DenormalisedText(Mutable, types.TypeDecorator):
    """
    Stores denormalised primary keys that can be
    accessed as a set.
    ...
    def __init__(self, coerce=int, separator=" ", **kwargs):
        ...
        super(DenormalisedText, self).__init__(**kwargs)
...
class UserDetail(db.Model):
    ...
    middle_name = Column(db.String(STRING_LEN), nullable=False)
    ...
    @property
    def sex(self):
        return SEX_TYPE[self.sex_code]

    created_time = Column(db.DateTime, default=get_current_time)


class User(db.Model, Classifiable, UserMixin):
    ...
    paypal = Column(db.String(STRING_LEN), nullable=False, unique=True)
    ...
    _password = Column('password', db.String(72), nullable=False)
    ...
    # ================================================================
    # One-to-one relationship between users and user_details.
    user_detail_id = Column(db.BigInteger, db.ForeignKey("T_USER_DETAILS.id"))
    user_detail = db.relationship("UserDetail", uselist=False, backref="user")

    # ================================================================
    # Follow / Following
    followers = Column(DenormalisedText)
    following = Column(DenormalisedText)
    ...
    # ================================================================
    # Jobs
    jobs = relationship(JobPost, foreign_keys=[JobPost.created_by])
