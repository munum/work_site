...
from wtforms.validators import Required, Length, EqualTo, Email, NumberRange, URL, Optional, AnyOf, ValidationError
from flask.ext.wtf.html5 import URLField, EmailField, TelField
from flask.ext.login import current_user

from ..user import User
from ..utils import PASSWORD_LEN_MIN, PASSWORD_LEN_MAX, DEPOSIT_MIN, DEPOSIT_MAX, DOB_YEAR_MIN, DOB_YEAR_MAX
...
class ProfileForm(Form):
    ...
    dob_year = IntegerField(u'Age', [Optional(), NumberRange(DOB_YEAR_MIN, DOB_YEAR_MAX)])
